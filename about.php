...
<html lang="ru">
  ...
  <body>
    <div
      class="modal-open contact-block modal-open-contact-block"
      style="display: none"
    >
        ...
        <div class="container">
          <div class="about-intro-row">
            <div class="about-intro-image">
              <img
                src="images/about/about-visual.png"
                alt="Aliance Production — производство химии"
              />
            </div>
            <div class="about-intro-content">
              ...
              <p class="about-intro-text">
                Разнообразный и богатый опыт говорят нам, что перспективное
                планирование однозначно фиксирует необходимость поставленных
                обществом задач! Ведь над чем задумываться: ключевые особенности
          ...
          <ul class="header-features header-features-light">
